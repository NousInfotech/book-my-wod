...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // Add this method for auto-scrolling to bottom
  ...
  void _sendVoiceMessage(String filePath) {
    ...
    // Auto-scroll after sending voice message
    Future.delayed(const Duration(milliseconds: 100), _scrollToBottom);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(profileData?['fullName'] ?? "Chat",
                          ...
                          child: Row(
                            ...
                            children: [
                              if (!isCurrentUser) // Show avatar for receiver
                                CircleAvatar(
                                  radius: 20,
                                  backgroundImage: profileData!['avatar_url'] !=
                                          null
                              ...
                              IntrinsicWidth(
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isCurrentUser
                                        ? Colors.blue[600]
                                        : Color.fromARGB(255, 255, 255, 255), // Different colors for sent vs received
                                            ...
                                            Align(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                    ...
                                                    color: isCurrentUser
                                                        ? Colors.white70
                                                        : Colors.grey[800]), // Fixed timestamp color
                                              ),
                                            ),
                                          ],
                                        ),
