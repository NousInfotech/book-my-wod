    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Message',
          style: TextStyle(
              fontSize: 24, fontWeight: FontWeight.bold, color: customWhite),
        ),
        actions: [
          Padding(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                          'assets/robot.jpeg'), // Replace with your asset image
                    ),
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: CircleAvatar(
            radius: 24,
            backgroundColor:
                hasUnreadMessages ? Colors.redAccent : Colors.blueAccent,
            child: Text(
              avatarText,
          ...
          title: Text(
            ...
            style: const TextStyle(
                fontSize: 18, fontWeight: FontWeight.bold, color: customWhite),
          ),
          subtitle: Text(
            lastMessage,
            style: TextStyle(
